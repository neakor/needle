    ...
    private func parseStructures() throws -> ([ASTComponent], [Dependency]) {
        ...
        for substructure in substructures {
            if substructure.isComponent {
                ...
                components.append(ASTComponent(name: substructure.name, dependencyProtocolName: dependencyProtocolName, properties: properties, expressionCallTypeNames: substructure.uniqueExpressionCallNames, isPresidioComponentAsFakeRoot: substructure.isPresidioComponent))
