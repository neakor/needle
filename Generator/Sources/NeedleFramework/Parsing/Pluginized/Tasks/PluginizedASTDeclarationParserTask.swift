    ...
    private func parsePluginizedStructures() throws -> ([PluginizedASTComponent], [ASTComponent], [PluginExtension]) {
        ...
        for substructure in substructures {
            if substructure.isPluginizedComponent {
                ...
                let component = ASTComponent(name: substructure.name, dependencyProtocolName: dependencyProtocolName, properties: properties, expressionCallTypeNames: substructure.uniqueExpressionCallNames, isPresidioComponentAsFakeRoot: substructure.isPresidioComponent)
